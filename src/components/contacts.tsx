...
import { Configs as GlobalConfigs } from "#utils/variables";
import useBlogConfigs from "#utils/config-context";
      ...
      <div className="contacts">
        ...
        <div className="between">
          <div className="socials">
            {GlobalConfigs.github && (
              <Link
                aria-label="github"
                href={GlobalConfigs.github}
                {...linkProps}
              >
                Github
              </Link>
            )}
            {GlobalConfigs.twitter && (
              <Link
                aria-label="twitter"
                href={GlobalConfigs.twitter}
                {...linkProps}
              >
                Twitter
              </Link>
        ...
        <style jsx>{`
          .contacts {
            width: ${GlobalConfigs.layouts.pageWidth};
          ...
          @media only screen and (max-width: ${theme.layout.breakpointMobile}) {
            .contacts {
              position: absolute;
              width: ${GlobalConfigs.layouts.pageWidthMobile};
            }
          }
        `}</style>
      </div>
